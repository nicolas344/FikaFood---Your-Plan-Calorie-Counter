    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Establece tu meta de consumo de agua diaria
        </p>
      </div>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-200 rounded-xl p-5">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div>
                <p className="font-semibold text-cyan-800 mb-2">Recomendaciones generales:</p>
                <ul className="space-y-2 text-sm text-cyan-700">
                  <li className="flex items-start gap-2">
                    <span className="text-cyan-500 mt-1">💧</span>
                    <span>Adultos: 2-3 litros por día</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-cyan-500 mt-1">🏃</span>
                    <span>Más cantidad si haces ejercicio</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-cyan-500 mt-1">🥤</span>
                    <span>Incluye agua de todas las fuentes</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          {generatedWater && (
            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 border-2 border-cyan-200 rounded-2xl p-6 shadow-lg">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="font-bold text-cyan-800 text-lg">Meta generada por IA</h4>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm border border-cyan-100">
                <div className="flex items-center justify-center gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-cyan-700 font-medium mt-1">Litros/día</p>
                  </div>
                  <div className="text-cyan-400 text-4xl">💧</div>
                  <div className="text-center">
                    <p className="text-2xl font-bold text-blue-600">{generatedWater.ml}</p>
                    <p className="text-sm text-blue-700 font-medium mt-1">ml/día</p>
                  </div>
                </div>
              </div>
            </div>
