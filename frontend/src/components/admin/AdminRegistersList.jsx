    ...
    return (
      <div className="flex items-center justify-center py-16">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-700 font-medium">Cargando registros...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Visualiza todos los registros de comidas</p>
        </div>
        <button
      ...
      {registers.length === 0 ? (
        <div className="text-center py-16 bg-white/90 backdrop-blur rounded-2xl border border-gray-200">
          ...
          <p className="text-gray-500 text-lg font-medium">No hay registros de alimentos</p>
          <p className="text-gray-400 text-sm mt-1">Los registros aparecerán aquí cuando los usuarios agreguen alimentos</p>
        </div>
      ) : (
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 mt-1">
                            Usuario: {register.user_email || 'N/A'} • {new Date(register.date).toLocaleDateString()}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pl-0 sm:pl-15">
                    <div className="flex flex-wrap gap-3">
                      ...
                      <div className="flex items-center gap-2 bg-yellow-50 px-3 py-1.5 rounded-lg border border-yellow-200">
                        <span className="text-xs font-medium text-yellow-700">Carbohidratos</span>
                      ...
                      <div className="flex items-center gap-2 bg-orange-50 px-3 py-1.5 rounded-lg border border-orange-200">
                        <span className="text-xs font-medium text-orange-700">Grasas</span>
