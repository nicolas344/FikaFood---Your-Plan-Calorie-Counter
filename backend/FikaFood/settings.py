"""
Django settings for FikaFood project.
...
WSGI_APPLICATION = 'FikaFood.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.2/ref/settings/#databases
# PostgreSQL en producción (Railway), SQLite3 en desarrollo local
