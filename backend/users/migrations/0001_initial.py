    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_level', models.CharField(choices=[('sedentary', 'Sedentario'), ('light', 'Actividad ligera'), ('moderate', 'Actividad moderada'), ('active', 'Muy activo'), ('extra', 'Extra activo')], default='sedentary', max_length=10)),
